...
from app.graph.nodes import classify_doc, flag_for_review, CONFIDENCE_THRESHOLD
...
def build_classify_graph():
    ...
    g.add_conditional_edges(
        ...
        route,
        {
            ...
            "high_confidence": END,
            # confident classifications skip flag_for_review entirely and the graph just ends
        }
    )
